...
//   final controller=Get.put(RegisteredCandidatesController());
...
//                     ? DashboardCardWidget(
//                         onTap: () {
//                           Get.toNamed('/eligibleCandidateScreenRoute',arguments: {'id': 1});
...
//                             onTap: () {
//                               Get.toNamed('/eligibleCandidateScreenRoute',arguments: {'id': 2});
...
//           onClicked: () => Get.toNamed('/registrationForm'),
//           icon: const Icon(
